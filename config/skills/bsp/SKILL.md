---
name: bsp
description: Применение 1С:БСП в прикладной разработке: правильные методы общих модулей, фоновые задания, обмен, ЭП/МЧД, печать, файлы, доступ, мониторинг. Используй когда нужно правильно применить Библиотеку стандартных подсистем (БСП) — какой модуль/метод вызвать, с какими параметрами, какие есть нюансы и антипаттерны.
