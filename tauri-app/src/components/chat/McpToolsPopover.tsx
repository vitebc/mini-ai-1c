...
export default function McpToolsPopover({
    ...
    return (
        <div
            ref={popoverRef}
            className="absolute bottom-full right-0 mb-2 w-[420px] bg-[#111113] border border-zinc-800 rounded-xl shadow-2xl overflow-hidden z-50 animate-in slide-in-from-bottom-2 duration-200"
        >
