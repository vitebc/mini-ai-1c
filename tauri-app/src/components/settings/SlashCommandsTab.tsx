                        ...
                        >
                            ...
                            <div className="flex items-center gap-2 shrink-0" onClick={e => e.stopPropagation()}>
                                <div
                                    ...
                                    className={`w-8 h-4 rounded-full relative transition-colors duration-200 cursor-pointer ${cmd.is_enabled ? 'bg-blue-600' : 'bg-zinc-500'}`}
                                >
                            ...
                            <div className="px-5 pb-5 pt-1 space-y-4 animate-in fade-in slide-in-from-top-2 duration-300">
                                ...
                                <div className="grid grid-cols-2 gap-4">
                                    <div className="space-y-1.5">
                                        ...
                                        <input
                                            ...
                                            className="w-full bg-zinc-700 border border-white/[0.05] rounded-lg px-3 py-2 text-sm text-zinc-200 focus:outline-none focus:border-blue-500/50 transition-colors"
                                ...
                                <div className="space-y-2">
                                    ...
                                    <textarea
                                        ...
                                        className="w-full h-32 bg-zinc-700 border border-white/[0.05] rounded-lg px-3 py-2 text-sm text-zinc-200 focus:outline-none focus:border-blue-500/50 transition-colors resize-none font-mono leading-relaxed shadow-inner"
