...
export function PromptsTab({ settings, onSettingsChange, onSave, saving }: PromptsTabProps) {
    ...
    const profileDescriptions: Record<PromptBehaviorPreset, { title: string; desc: string; icon: any; color: string; badge: string }> = {
        ...
        cli: {
            title: 'Разработка',
            desc: 'Полноценная разработка: чистый код по стандартам 1С и БСП, правки и оптимизация в рамках запроса. Экономный расход токенов.',
            icon: Terminal,
        ...
        planning: {
            title: 'Планирование',
            desc: 'Read-only анализ конфигурации и составление плана изменений. Без правок кода — только исследование и структурированный план.',
            icon: Code,
