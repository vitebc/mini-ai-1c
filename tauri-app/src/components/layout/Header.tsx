        ...
        <div className="flex items-center justify-between px-4 py-2 border-b border-zinc-700 bg-zinc-900">
            ...
            <div className="flex items-center gap-2">
                <button
                    ...
                    className="p-2 hover:bg-zinc-700 rounded-lg transition-colors text-zinc-400 group"
                ...
                {false && (
                    <button
                        ...
                        className="p-2 rounded-lg transition-colors text-zinc-400 hover:bg-zinc-700 hover:text-zinc-200"
