...
export function ConflictDialog({
    ...
    return (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm animate-in fade-in duration-200">
            <div className="w-full max-w-md bg-[#1c1c1e] border border-[#2a2a2c] rounded-xl shadow-2xl overflow-hidden animate-in zoom-in-95 duration-200">
                {/* Header */}
                <div className="p-4 border-b border-[#2a2a2c] flex items-center justify-between bg-zinc-900/50">
                ...
                <div className="p-6 space-y-4">
                    ...
                    <div className="grid gap-3">
                        <button
                            ...
                            className="flex items-start gap-3 p-3 rounded-lg border border-[#2a2a2c] bg-zinc-900/50 hover:bg-zinc-800 transition-all group text-left"
                        >
                ...
                {/* Footer */}
                <div className="p-3 border-t border-[#2a2a2c] bg-zinc-900/50 flex justify-end">
                    <button
                        onClick={onClose}
