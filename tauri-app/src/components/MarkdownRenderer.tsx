...
const LargeBslCodeBlock = memo(function LargeBslCodeBlock({ codeString, onApplyCode }: LargeBslCodeBlockProps) {
    ...
    return (
        <div className="relative my-4 group w-full">
            <div className="flex flex-wrap items-center justify-between gap-y-1 px-3 py-1.5 bg-zinc-800/80 backdrop-blur-sm rounded-t-lg border-x border-t border-[#2a2a2c]">
            ...
            <div className="bg-[#222224] border border-[#2a2a2c] rounded-b-lg overflow-hidden border-t-0">
...
const CodeBlock = memo(({ inline, className, children, isStreaming, onApplyCode, originalCode, ...props }: CodeBlockProps) => {
    ...
    if (inline || !isMultiline) {
        return (
            <code
                className="bg-[#2a2a2c] text-blue-300 font-semibold px-1.5 py-0.5 rounded-md text-[13px] font-mono border border-zinc-700/50 max-w-full overflow-x-auto inline-flex align-middle scrollbar-hide"
    ...
    if (isStreaming) {
        return (
            <div className="relative my-4 group w-full">
                <div className="flex items-center justify-between px-3 py-1.5 bg-zinc-800/80 backdrop-blur-sm rounded-t-lg border-x border-t border-[#2a2a2c]">
                ...
                <div className="bg-[#222224] border border-[#2a2a2c] rounded-b-lg overflow-hidden border-t-0 min-h-[50px] max-h-[400px] flex">
                ...
                {isFullscreen && (
                    <div className="fixed inset-0 z-[100] bg-zinc-950/95 flex flex-col backdrop-blur-md animate-in fade-in zoom-in duration-200">
                        ...
                        <div className="flex-1 p-8 overflow-hidden">
                            <div className="w-full h-full rounded-2xl border border-zinc-800 overflow-hidden shadow-2xl bg-[#222224]">
                                {showDiff && hasDiff ? (
    ...
    return (
        <div className="relative my-2 group w-full">
            <div className="flex items-center justify-between px-3 py-1 bg-zinc-800 rounded-t-lg border-x border-t border-[#2a2a2c]">
                <div className="flex items-center gap-2">
            ...
            <pre className="bg-[#1c1c1e] border border-[#2a2a2c] rounded-b-lg p-4 overflow-x-auto border-t-0 text-zinc-300">
